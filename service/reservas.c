...
{
    // 1. DECLARAÄ«O DE TODAS AS VARIµVEIS NO IN÷CIO
    ListaAcomodacao *auxAcom;
    TipoCategoria categoriaTemp;
    ListaCategoria *posCat; // Vari†vel para receber a posiá∆o da categoria na busca
    int encontrouAlgum;
    int conflito;
    ...
    while (auxAcom != NULL)
    {
        ...
        // Exibiá∆o detalhada para o operador com os dados mesclados
...
void listarReservasPorAcomodacao(ListaReservas *lista, int idAcomodacao)
{
    ...
    if (!encontrou)
    {
        printf("Nenhuma reserva encontrada para a acomodaá∆o ID %d.\n", idAcomodacao);
    }
...
ListaReservas *resgataDadosReservasTxt(char *nome_arquivo)
{
    ...
    while (fgets(linha, sizeof(linha), arquivo))
    {
        ...
        // Là como long long e converte de volta para o formato de tempo nativo do C
...
void interfaceReservas(ListaReservas *listaRes, ListaAcomodacao *listaAcom, ListaCategoria *listaCat, ListaHospede *listaHospedes)
{
    ...
    do
    {
        ...
        printf("4 - Filtrar Acomodaá‰es Dispon°veis\n");
        printf("5 - Verificar reservas por acomodaá∆o\n");
        ...
        case 1: // ADICIONAR RESERVA (FILTROS DE BUSCA)
            ...
            novaReserva.id = escolheIdReserva(listaRes); // Chama a funá∆o para gerar ID incremental
        ...
        case 4:
            system("cls");
            printf("--- Filtro de Acomodaá‰es Dispon°veis ---\n\n");
        ...
        case 5:
            ...
            fflush(stdin);
            system("cls");
            printf("--- Reservas para Acomodaá∆o ID %d ---\n\n", idBusca);
